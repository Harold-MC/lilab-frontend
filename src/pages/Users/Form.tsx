...
import { Button, FormControl, FormHelperText, Grid2, Stack, TextField, Typography, Select, InputLabel, MenuItem, Autocomplete } from "@mui/material"
import { useController, useForm } from "react-hook-form";
import { yupResolver } from "@hookform/resolvers/yup";
import { IUser } from "@/interfaces/models";
import { schema, type UserForm } from "./schema";
...
const UserForm: FC<{
    ...
    return <Stack spacing={2}>
        <Typography color="info" variant="h5" fontWeight="bold">{user ? 'Editar' : 'Crear'} Usuario</Typography>
        ...
        <Grid2 spacing={2} container>
            ...
            <Grid2 size={{ md: 6, xs: 12 }}>
                <FormControl fullWidth>
                    ...
                    />
                    {'role' in errors && <FormHelperText error>{errors.role?.message}</FormHelperText>}
                </FormControl>
            </Grid2>
            <Grid2 size={{ md: 6, xs: 12 }}>
                <FormControl fullWidth>
